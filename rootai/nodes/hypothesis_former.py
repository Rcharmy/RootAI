...
- Hypothesis updates use the SAME id as the existing hypothesis. The
  ...
  hypotheses get a fresh id (generated by the LLM or by us).
- Prompt explicitly permits INCONCLUSIVE verdicts. This is the
  calibration property the null eval cases test.
...
def hypothesis_former_node(state: InvestigationState) -> dict:
    """Real Hypothesis Former: LLM proposes/updates hypotheses with linked evidence."""
